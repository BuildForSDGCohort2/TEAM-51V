        ...
        <div className="ag-main">
          <section className="login-wrapper">
            <div className="login-header">
              <img src={require('../../assets/img/ag-logo.png')} alt="" />
            ...
            <div className="login-footer">
              <a id="joinBtn"
                ...
                className="ag-rounded button is-info i rounded">Join
                  </a>
            </div>
          </section>
        </div>
    ...
    return (
      <div className="channel-wrapper control has-icons-left">
        ...
        <span className="icon is-small is-left">
          <img src={require('../../assets/img/ag-login.png')} alt="" />
        </span>
...
export default withHooks(JoinMeeting)